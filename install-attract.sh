...
# get the addon archive file from github
	  ...
	  wget --no-check-certificate -w 4 -O plugin.program.attract-launcher-0.0.1.tgz https://github.com/PiDiaries/Retroattract/raw/master/plugin.program.attract-launcher-0.0.1.tgz 2>&1 | grep --line-buffered -oP "(\d+(\.\d+)?(?=%))" | dialog --title "Downloading Addon" --gauge "\nPlease wait...\n"  11 70
...
# download new versions of all scripts and make them executable
	    wget --no-check-certificate -w 4 -O /home/osmc/RetroPie/scripts/retropie.sh.1 https://raw.githubusercontent.com/mcobit/retrosmc/master/scripts/retropie.sh
            ...
            wget --no-check-certificate -w 4 -O /home/osmc/RetroPie/scripts/attract.sh.1 https://raw.githubusercontent.com/PiDiaries/Retroattract/master/scripts/attract.sh
